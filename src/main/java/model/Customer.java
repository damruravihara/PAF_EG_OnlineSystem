...
public class Customer {
	...
	public String insertCustomer(String cus_name, String cus_address, String cus_phone_no, String cus_nic, String username, String password) {
		...
		try {
			...
			String query = "  insert into customer (`idcustomer`,`cus_name`,`cus_address`,`cus_phone_no`,`cus_nic`,`username`,`password`)" + " values (?, ?, ?, ?, ?,?,?)";
